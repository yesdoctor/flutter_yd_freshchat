...
public class SwiftFlutterYdFreshchatPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "flutter_yd_freshchat", binaryMessenger: registrar.messenger())
        let instance = SwiftFlutterYdFreshchatPlugin(registrar: registrar)
        registrar.addMethodCallDelegate(instance, channel: channel)
    }

    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        switch(call.method){
            case SwiftFlutterYdFreshchatPlugin.METHOD_INIT:
            ...
            case SwiftFlutterYdFreshchatPlugin.METHOD_IDENTIFY_USER:
            ...
            case SwiftFlutterYdFreshchatPlugin.METHOD_SHOW_CONVERSATIONS:
                let arguments = call.arguments as! [String: Any]
            ...
            case SwiftFlutterYdFreshchatPlugin.METHOD_SHOW_FAQS:
            ...
            case SwiftFlutterYdFreshchatPlugin.METHOD_SEND_MESSAGE:
                let arguments = call.arguments as! [String: String]
