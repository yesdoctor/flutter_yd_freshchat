...
static const NSString* METHOD_GET_RESTORE_ID = @"getRestoreId";
...
static const NSString* METHOD_HANDLE_NOTIFICATION = @"handleNotification";
static const NSString* METHOD_IS_FRESHCHAT_NOTIFICATION = @"isFreshchatNotification";

@implementation FlutterYdFreshchatPlugin

+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"flutter_yd_freshchat"
            binaryMessenger:[registrar messenger]];
  FlutterYdFreshchatPlugin* instance = [[FlutterYdFreshchatPlugin alloc] initWithRegistrar:registrar];
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  if ([@"getPlatformVersion" isEqualToString:call.method]) {
    result([@"iOS " stringByAppendingString:[[UIDevice currentDevice] systemVersion]]);
  ...
  else if ([METHOD_GET_RESTORE_ID isEqualToString:call.method]) {

        result([FreshchatUser sharedInstance].restoreID);
  }
      ...
      result([NSNumber numberWithBool:isFreshchatNotification]);
  }
